...
module.exports = function(app) {
  ...
  var sendDataMessage = function(req, numberPressed) {
    ...
    var url = "http://vizzuality.github.io/WRW-Prototype/dashboard.html#" + country.iso3;
    bitly.shorten(url).then(function(response) {
      ...
      twilioClient.sendMessage({
        from: req.query.To,
        to: req.query.Caller,
        body: "Check out Resource Watch for more " + source.name + " data " + short_url + " or learn about Resource Watch http://resourcewatch.org"
